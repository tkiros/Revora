...
You are the LLM compliance layer for Revora's video engine. You read a `VideoSpec` and
...
Revora. The engine must never generate them, and you must hard-fail any spec that

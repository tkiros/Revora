 ...
 *
 * Revora models *food* risk. It has never modelled *clinical* risk — so before
...
const ROUTE_PATTERNS: Record<ClinicalRoute, RegExp[]> = {
  ...
  // Insulin or medication dose/change. Revora must never touch a dose.
  medication_dosing: [
    ...
    // addresses it ("Revora does not know your medicine or your readings").
  ...
  // the A1C bands Revora reasons over are not the ones used in pregnancy.
  pregnancy: [
  ...
  // Serious allergy or intolerance. Revora cannot confirm allergen safety —
  ...
  // Type 1 / established type 2 — out of Revora's stated scope. The advice

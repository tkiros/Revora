...
| `NIDDK-HYPOGLYCEMIA` | NIDDK, Low Blood Glucose (Hypoglycemia) | That suspected low blood glucose needs prompt action, that the 15-15 rule (about 15 grams of fast-acting carbs, recheck in 15 minutes) is the universally taught first response, and that severe or worsening symptoms need urgent help. | Tell a user reporting low-blood-sugar symptoms the 15-15 first step, defer to any plan their doctor gave them, and direct urgent help if it worsens. | Do not say the user is having a hypoglycemic episode, do not advise on medication, and do not go beyond the single universally-taught first-aid step. | HIGH | Supports `clinical-possible-hypoglycemia`. 2026-07-16 owner decision reversed the earlier no-numbers stance: the 2026-07-16 panel was unanimous that omitting the 15-15 step under-actions a genuine emergency. |
| `ADCES-HYPO-ROADMAP` | ADCES, Hypoglycemia Treatment Plan Roadmap (low blood sugar handout) | The 15-15 first response for a suspected low: about 15 grams of fast-acting carbohydrate (glucose tablets, juice, regular soda), recheck after 15 minutes, escalate if not improving. | Support the exact first-aid wording in `clinical-possible-hypoglycemia` — one widely taught step, stated once. | Do not extend into dosing, medication timing, or individualized plans; do not present the step as a substitute for the user's own clinical plan. | HIGH | Added 2026-07-16 with the owner-approved copy expansion. Same source family the W-05 protocol already anchors on (`docs/qa/dietitian-review/README.md`). |
| `SAMHSA-988-LIFELINE` | SAMHSA, 988 Suicide & Crisis Lifeline (program facts) | That 988 is a live US call/text line operating 24/7, staffed by trained crisis counselors, and open to any emotional distress — including eating-related struggles — not only suicidality. | Support the urgency framing in `clinical-eating-disorder`: "call or text 988 now — live support, any hour, and eating struggles count." | Do not present 988 as eating-disorder treatment, therapy, or a clinical service; do not claim outcomes; do not use it to replace the talk-to-a-professional-soon direction. | HIGH | Added 2026-07-16 with the doc-18 ED-copy revision (2 of 3 panel personas: 988 named but urgency unframed). US-jurisdiction resource per the governance record. |

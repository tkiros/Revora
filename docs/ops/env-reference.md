...
| `REVORA_ENFORCE_COMPONENT_MENTION` | runtime engine toggle | `lib/revora/postprocess.ts`: opts into the stricter component-mention check on model output. Unset keeps the default posture |
